...
/**
 * Concrete class represents the state of using radio VFO A.
 * 
 * @author Coz
 */
public class VfoAState extends VfoState {
    VfoAState(JTextField aField , JRadioButtonMenuItem aButton) {
        stateName = VFO_A; 
        field = aField;
        button = aButton;
    }
